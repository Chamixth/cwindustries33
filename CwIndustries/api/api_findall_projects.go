...
// @Router      /FindallProjects [GET]


    func FindallProjectsApi(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse,error) {


inputObj, err := dao.DB_FindallProjects()
    if err != nil {
