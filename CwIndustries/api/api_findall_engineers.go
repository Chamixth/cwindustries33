...
// @Router      /FindallEngineers [GET]


    func FindallEngineersApi(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse,error) {


inputObj, err := dao.DB_FindallEngineers()
    if err != nil {
