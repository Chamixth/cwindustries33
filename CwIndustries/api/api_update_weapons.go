...
// @Summary      PUT Weapons input: Weapons
// @Description  PUT Weapons API
// @Tags         PUT Weapons - Weapons
// @Accept       json
// @Produce      json
...
// @Router      /UpdateWeapons [PUT]


    func UpdateWeaponsApi(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse,error) {
...
inputObj := dto.Weapons{}
    ...
    //}
err := dao.DB_UpdateWeapons(&inputObj)
    if err != nil {
        return events.APIGatewayProxyResponse{StatusCode: http.StatusBadRequest, Body: err.Error()},nil
    }
