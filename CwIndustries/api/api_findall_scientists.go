...
// @Router      /FindallScientists [GET]


    func FindallScientistsApi(ctx context.Context, event events.APIGatewayProxyRequest) (events.APIGatewayProxyResponse,error) {


inputObj, err := dao.DB_FindallScientists()
    if err != nil {
